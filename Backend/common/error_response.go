...
var ErrorInvalidEmailPassword = DefaultError{
	StatusField: http.StatusText(http.StatusBadRequest), // 400 Bad Request
	ErrorField:  "Email hoặc mật khẩu không hợp lệ",
	CodeField:   http.StatusBadRequest,
}
